  ...
  <div>
    ...
    <div class="flex justify-between">
      ...
      <div>
        ...
        <p class="text-[14px] font-normal pr-[8px] mr-[8px]">
          {{ data?.weight }} Ibs
        </p>
      </div>
      <div class="mr-[26px]">
        ...
        <p
          class="text-[12px] text-[#0FB600] rounded-md bg-[#0FB6001A] py-1 px-3 font-normal pr-[8px] mr-[8px]"
        >
          {{ data?.demand }} High Demand
        </p>
      </div>
    </div>
  </div>
